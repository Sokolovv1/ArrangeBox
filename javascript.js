...
class ArrangeBox {
    ...
    let AvailableWrapper = document.createElement("div");
    ...
    let button_list_left = document.createElement("div");
    ...
    let js_left_up = document.createElement("button");
    ...
    let js_left_down = document.createElement("button");
    ...
    let js_left_all_up = document.createElement("button");
    ...
    let js_left_all_down = document.createElement("button");
    ...
    let button_list_center = document.createElement("div");
    ...
    let js_left = document.createElement("button");
    ...
    let js_right = document.createElement("button");
    ...
    let js_left_all = document.createElement("button");
    ...
    let js_right_all = document.createElement("button");
    ...
    let js_add_right = document.createElement("button");
    ...
    let js_add_left = document.createElement("button");
    ...
    let js_refresh = document.createElement("button");
    ...
    let js_get_current_values = document.createElement("button");
    ...
    let button_list_right = document.createElement("div");
    ...
    let js_right_up = document.createElement("button");
    ...
    let js_right_down = document.createElement("button");
    ...
    let js_right_all_up = document.createElement("button");
    ...
    let js_right_all_down = document.createElement("button");
...
RefreshPage() {
    let js_container1 = document.getElementById("js-container1 container");
    ...
    let js_container2 = document.getElementById("js-container2 container");
...
handleClick(event){
    let elements = document.getElementsByClassName("ArrangeBox-item js-item");
...
searchLeft(){
    ...
    let List = document.getElementById("js-container1 container").childNodes;
...
searchRight() {
    let value = event.target.value.toLowerCase();
    let List = document.getElementById("js-container2 container").childNodes;
